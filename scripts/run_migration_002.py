...
def run_migration():
    """Ejecuta la migración SQL para agregar la tabla de archivos de proyectos"""
    ...
    print(f"   Archivo leído: {len(sql_script)} caracteres")
...
if __name__ == "__main__":
    print("=" * 60)
    print("MIGRACIÓN 002: Agregar Archivos de Proyectos")
    print("=" * 60)
    print()
    ...
    if success:
        ...
        print("  3. Los archivos se procesarán automáticamente y estarán disponibles para la IA")
    else:
